...
{
  public:
    MCP3008(int clockpin, int mosipin, int misopin, int cspin, int cspin2, int cspin3, int cspin4);
    int readADC(int adcnum);
  private:
      int _clockpin, _mosipin, _misopin, _cspin, _cspin2, _cspin3, _cspin4, _cspin1;
};
